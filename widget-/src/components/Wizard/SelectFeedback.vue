<template>
  <div class="flex justify-between w-full my-5">
    <button
      ...
      flex flex-col justify-center items-center p-5 w-28 cursor-pointer focus:outline-none">
        <div class="w-12">
          <img class="w-full" src="../../assets/images/issue.png" alt="problema">
        </div>
        <p class="mt-1 text-gray-800 font-medium">Problema</p>
    </button>
    ...
    <button
      ...
      flex flex-col justify-center items-center p-5 w-28 cursor-pointer focus:outline-none">
        ...
        <p class="mt-1 text-gray-800 font-medium">Ideia</p>
    </button>
    ...
    <button
      ...
      flex flex-col justify-center items-center p-5 w-28 cursor-pointer focus:outline-none">
        ...
        <p class="mt-1 text-gray-800 font-medium">Outro</p>
      </button>
  </div>
</template>
